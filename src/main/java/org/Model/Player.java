...
public class Player implements Serializable {
     ...
     */
    public List<Country> d_countryCaptured;
    ...
    BehaviourStrategy d_playerStrategy;
    ...
    public BehaviourStrategy getPlayerStrategy() {
        return d_playerStrategy;
    }

    public void setPlayerStrategy(BehaviourStrategy d_playerStrategy) {
    ...
    public void getContinentsOwned(List<Continent> d_continentsOwned) {
    ...
    public void removeCountryCaptured(Country p_country){
        d_countryCaptured.remove(p_country);
    }
    ...
    public String toString() {
        return "Player{" +
                "d_color='" + d_color + '\'' +
                ", d_playerName='" + d_playerName + '\'' +
                ", d_countryCaptured=" + d_countryCaptured +
                ", d_continentsOwned=" + d_continentsOwned +
                ", d_orderList=" + d_orderList +
                ", d_numOfArmiesRemaining=" + d_numOfArmiesRemaining +
                ", d_cardsOwnedByPlayer=" + d_cardsOwnedByPlayer +
                ", d_negotiatedPlayers=" + d_negotiatedPlayers +
                ", d_moreOrdersFlag=" + d_moreOrdersFlag +
                ", d_cardAssignedForThisTurnFlag=" + d_cardAssignedForThisTurnFlag +
                ", d_playerStrategy=" + d_playerStrategy +
                '}';
    }
}
