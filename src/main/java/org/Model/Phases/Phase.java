...
public abstract class Phase implements Serializable {
     ...
     */
    protected transient BufferedReader d_bufferReader = new BufferedReader(new InputStreamReader(System.in));
     ...
     */
    protected abstract void performEditContinent(Command l_cmd, Player p_player) throws MapInvalidException, InvalidCommand, IOException;
     ...
     * @throws InvalidCommand : If there is some issues with the command
     */
    protected abstract void performEditCountry(Command l_cmd, Player p_player) throws MapInvalidException, InvalidCommand, IOException;
     ...
     */
    protected abstract void performLoadMap(Command l_cmd, Player p_player) throws InvalidCommand, IOException, MapInvalidException;
     ...
     * @throws InvalidCommand : If there is some issues with the command
     */
    protected abstract void performShowMap(Player p_player) throws InvalidCommand, IOException;
     ...
     */
    protected abstract void performValidateMap(Player p_player) throws MapInvalidException, InvalidState, IOException, InvalidCommand;
     ...
     * @throws InvalidCommand      : If there is some issues with the command
     */
    protected abstract void performAssignCountries(Command p_command, Player p_player, boolean isTournamentMode, GameState p_gameState) throws InvalidCommand, MapInvalidException, InvalidState, IOException;
     ...
     * @throws InvalidCommand : If there is some issues with the command
     */
    protected abstract void performCreatePlayers(Command l_cmd, Player p_player) throws InvalidCommand, IOException;
     ...
     */
    public abstract void initPhase(boolean p_isTournament) throws InvalidState, IOException, InvalidCommand;
    ...
    public abstract void performSaveGame(Command l_cmd, Player p_player) throws InvalidCommand, InvalidState, IOException;

    public abstract void performLoadGame(Command l_cmd, Player p_player) throws InvalidCommand, InvalidState, IOException;

    public abstract void performTournamentGame(String l_cmd) throws InvalidCommand, InvalidState, MapInvalidException;

    /**
     * Contains the start up message of each phase
     */
    public abstract void printStartingOptions(boolean p_isTournament);
        ...
        try {
            ...
            switch (l_mainOperation) {
                ...
                case "assigncountries":{
                    performAssignCountries(l_cmd, p_player, false, d_currentGameState);
                    break;
                }
                case "deploy": {
                ...
                case "savegame": {
                    performSaveGame(l_cmd,p_player);
                    break;
                }
                case "loadgame": {
                    performLoadGame(l_cmd,p_player);
                    break;
                }
                case "tournament": {
                    performTournamentGame(p_command);
                    break;
                }
                case "airlift":
                case "blockade":
